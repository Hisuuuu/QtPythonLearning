...
class Widget(QWidget):
    ...
    def button_clicked_critical(self):
        ret = QMessageBox.critical(self,"Message Tittle","Critical Message!", QMessageBox.Ok | QMessageBox.Cancel)
        if ret == QMessageBox.Ok : 
            print("User chose OK")
        else : 
            print ("User chose Cancel")
    ...
    def button_clicked_question(self):
        ret = QMessageBox.question(self,"Message Tittle","Asking a question?", QMessageBox.Ok | QMessageBox.Cancel)
        if ret == QMessageBox.Ok : 
            print("User chose OK")
        else : 
            print ("User chose Cancel")
